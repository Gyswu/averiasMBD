<?php
// source: /Users/jorge/Desktop/averiasMBD/app/config/common.neon
// source: /Users/jorge/Desktop/averiasMBD/app/config/local.neon
// source: array
...
class Container_fcef00cc59 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'Nextras\Orm\Mapper\Mapper' => [['orm.mappers.usuarios', 'orm.mappers.averias', 'orm.mappers.empresa']],
		'Nextras\Orm\Mapper\Dbal\DbalMapper' => [['orm.mappers.usuarios', 'orm.mappers.averias', 'orm.mappers.empresa']],
		'Nextras\Orm\Mapper\BaseMapper' => [['orm.mappers.usuarios', 'orm.mappers.averias', 'orm.mappers.empresa']],
		'Nextras\Orm\Mapper\IMapper' => [['orm.mappers.usuarios', 'orm.mappers.averias', 'orm.mappers.empresa']],
		'App\Model\Orm\UsuariosMapper' => [['orm.mappers.usuarios']],
		'Nextras\Orm\Repository\Repository' => [['orm.repositories.usuarios', 'orm.repositories.averias', 'orm.repositories.empresa']],
		'Nextras\Orm\Repository\IRepository' => [['orm.repositories.usuarios', 'orm.repositories.averias', 'orm.repositories.empresa']],
		...
		'App\AdminModule\Presenters\UsersPresenter' => [2 => ['application.1']],
		'App\AdminModule\Presenters\UsuariosPresenter' => [2 => ['application.2']],
		'App\AdminModule\Presenters\EmpresasPresenter' => [2 => ['application.3']],
		'App\AdminModule\Presenters\SupportPresenter' => [2 => ['application.4']],
		'App\AdminModule\Presenters\HomepagePresenter' => [2 => ['application.5']],
		'App\AdminModule\Presenters\AveriasPresenter' => [2 => ['application.7']],
		'App\Presenters\ClasesPresenter' => [2 => ['application.8']],
		'App\Presenters\CentrosPresenter' => [2 => ['application.9']],
		'App\Presenters\ErrorPresenter' => [2 => ['application.10']],
		'App\Presenters\SignPresenter' => [2 => ['application.11']],
		'App\Presenters\UsuariosPresenter' => [2 => ['application.12']],
		'App\Presenters\CalendariosPresenter' => [2 => ['application.13']],
		'App\Presenters\HomepagePresenter' => [2 => ['application.14']],
		'App\Presenters\Error4xxPresenter' => [2 => ['application.15']],
		'NetteModule\ErrorPresenter' => [2 => ['application.16']],
		'NetteModule\MicroPresenter' => [2 => ['application.17']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/Users/jorge/Desktop/averiasMBD/app',
			'wwwDir' => '/Users/jorge/Desktop/averiasMBD/www',
			'vendorDir' => '/Users/jorge/Desktop/averiasMBD/vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => '/Users/jorge/Desktop/averiasMBD/app/../temp',
		];
	}
	...
	public function createServiceApplication__1(): App\AdminModule\Presenters\UsersPresenter
	{
	...
	public function createServiceApplication__10(): App\Presenters\ErrorPresenter
	{
	...
	public function createServiceApplication__12(): App\Presenters\UsuariosPresenter
	{
	...
	public function createServiceApplication__13(): App\Presenters\CalendariosPresenter
	{
	...
	public function createServiceApplication__14(): App\Presenters\HomepagePresenter
	{
	...
	public function createServiceApplication__15(): App\Presenters\Error4xxPresenter
	{
	...
	public function createServiceApplication__16(): NetteModule\ErrorPresenter
	{
	...
	public function createServiceApplication__17(): NetteModule\MicroPresenter
	{
	...
	public function createServiceApplication__2(): App\AdminModule\Presenters\UsuariosPresenter
	{
	...
	public function createServiceApplication__3(): App\AdminModule\Presenters\EmpresasPresenter
	{
	...
	public function createServiceApplication__6(): App\AdminModule\Presenters\BaseAdminPresenter
	{
	...
	public function createServiceApplication__7(): App\AdminModule\Presenters\AveriasPresenter
	{
	...
	public function createServiceApplication__8(): App\Presenters\ClasesPresenter
	{
	...
	public function createServiceApplication__9(): App\Presenters\CentrosPresenter
	{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/Users/jorge/Desktop/averiasMBD/app/../temp/cache/nette.application/touch'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/Users/jorge/Desktop/averiasMBD/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Users/jorge/Desktop/averiasMBD/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}


	public function createServiceContainer(): Container_fcef00cc59
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_fcef00cc59 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Users/jorge/Desktop/averiasMBD/app/../temp/cache/latte');
